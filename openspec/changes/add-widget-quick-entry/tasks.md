...
- [x] 1.1 Add App Group entitlement (`group.dev.jimfrederick.spendthrift`) to app target; move ModelConfiguration to the group container URL
...
- [x] 1.3 Extract container construction into a shared `SpendthriftContainer` helper used by app and extension

## 2. Quick-log presets (SpendthriftCore)
...
- [x] 3.1 Add `SpendthriftWidgets` target (WidgetKit) to project.yml with App Group entitlement; regenerate project
