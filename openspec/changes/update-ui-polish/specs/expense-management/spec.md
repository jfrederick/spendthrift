...
The period expense list (day, week, or month drill-in) SHALL offer a category filter listing the categories present in that period's expenses plus an "All Categories" option. Selecting a category SHALL show only that category's expenses, keeping the day grouping; selecting "All Categories" SHALL restore the full list. The filter SHALL default to all categories on entry.
